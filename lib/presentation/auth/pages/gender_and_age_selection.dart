...
import 'package:ecome_clean/common/helper/bottomsheet/app_bottomsheet.dart';
...
import 'package:ecome_clean/presentation/auth/bloc/age_selection_cubit.dart';
import 'package:ecome_clean/presentation/auth/bloc/ages_display_cubit.dart';
import 'package:ecome_clean/presentation/auth/bloc/gender_selection_cubit.dart';
import 'package:ecome_clean/presentation/auth/widgets/ages.dart';
...
class GenderAndAgeSelectionPage extends StatelessWidget {
  final RegisterParams repo;
  const GenderAndAgeSelectionPage({super.key, required this.repo});
                ...
                return BasicReactiveButton(
                  onPressed: () async {
                    final gender = context
                        ...
                        .selectedIndex;
                    final age = context.read<AgeSelectionCubit>().state;
                    final updatedParams = repo.copyWith(
                      gender: gender,
                      age: age,
                    );
                    final signUpUsecase = SignUpUsecase(sl());
