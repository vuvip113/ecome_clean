...
import 'package:ecome_clean/presentation/settings/pages/order_items.dart';
...
class OrderDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: BasicAppbar(
        title: Text('Order #${orderEntity.code.split('_').last}'),
      ),
      ...
      itemBuilder: (context, index) {
        return Row(
          ...
          children: [
            ...
            Text(
              orderEntity.orderStatus[index].createdDate.toString().split(
                ' ',
              )[0],
              style: TextStyle(
                fontWeight: FontWeight.w500,
